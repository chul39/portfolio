  ...
  >
    ...
    <template v-slot:carousel-slides>
      <li v-if="showModal && currentSlide === 0" class="carousel-slide">
        <img src="@/assets/imgs/project1/ss00.jpg"/>
      </li>
      <li v-if="showModal && currentSlide === 1" class="carousel-slide">
        <img src="@/assets/imgs/project1/ss01.jpg"/>
      </li>
      <li v-if="showModal && currentSlide === 2" class="carousel-slide">
        <img src="@/assets/imgs/project1/ss02.png"/>
      </li>
    </template>
  ...
  setup() {
    ...
    const keys = {
      ...
      "JP": {
        ...
        aboutDev: "最初は無料テンプレートを使おうと思っていますが、好きなテンプレートが見つからなかったので自分でこのポートフォリオサイトを作りました。フロントエンド開発の基礎知識を復習するために、できるまでフレームワークを使わないようにしました。",
      }
    }
