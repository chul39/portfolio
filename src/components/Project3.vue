...
export default {
  ...
  setup() {
    ...
    const keys = {
      "EN": {
        content: "A game where players can import external music files into the game and let it generate game stages automatically based on them. The game requires the player to avoid getting hit by the obstacles while collecting items which will be placed according to the beat of the imported song. The game level is generated by sampling the audio to get its spectrum data and then the pattern is determined by the frequency level of the audio wave.",
