  ...
  setup() {
    ...
    const keys = {
      "EN": {
        ...
        aboutDev: "During my 2nd year in the university, I teamed up with 6 other students to help International School of Engineering, Chulalongkorn University create web applications for online enrollment and interview management. As this was the first time my project has been used in a real life, I've learned on how to work with a real client and also how to work as a team."
      },
      "JP": {
